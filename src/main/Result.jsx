...
export default function Result() {
    ...
    return (
        <div className="w-full flex items-center justify-center relative z-99 rounded-b-2xl backdrop-blur-xl dark:bg-bg bg-bg md:pt-20 dark:text-text text-text">

            <div className="md:w-6xl w-full flex flex-col gap-6 md:py-4 py-4 p-2 pt-18">
                <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2 border rounded-lg dark:border-border border-border p-2 px-2 pr-3 dark:bg-muted-bg bg-muted-bg backdrop-blur-2xl cursor-pointer">
                        <i class="ph ph-arrow-left"></i>
                        <h1 className="text-xs font-bold">Logout</h1>

                    </div>

                    <div className="flex items-center gap-2 border rounded-lg border-white/10 p-2 px-2 bg-white/7 backdrop-blur-2xl cursor-pointer">
                        <i class="ph ph-download-simple"></i>
                        <h1 className="text-xs font-bold pr-1">Export PDF</h1>
                        <i class="ph ph-caret-down"></i>
                    </div>
                </div>

                <div className="w-full bg-white/5 backdrop-blur-2xl border border-white/10 rounded-2xl p-4 flex flex-col gap-6">
                ...
                {/* Semester Details */}
                <div className="w-full md:bg-white/5 backdrop-blur-2xl  md:border md:border-white/10 rounded-2xl md:p-4 md:px-8 flex flex-col gap-3">
                ...
                <div className="w-full md:bg-white/5 backdrop-blur-2xl  md:border border-white/10 rounded-2xl md:p-4 flex flex-col gap-6">
                    <div className="px-4">
                    ...
                    <div className="overflow-x-auto rounded-xl border border-white/20 md:hidden bg-white/5">
                ...
                <div className="flex items-center gap-3 backdrop-blur-2xl  text-xs border p-4 rounded-2xl border-white/10 bg-white/5">
                ...
                <div className="w-full bg-muted-bg backdrop-blur-2xl  border border-white/10 rounded-2xl p-5 px-4 flex flex-col gap-6">
                    <div>
                        <h1 className="font-bold text-2xl leading-6 pb-2">Result Available For All GGSIPU Programmes</h1>
                        <p className="text-xs text-muted-text">We support result checking for the following GGSIPU programs:</p>
                    </div>

                    <div className="grid grid-cols-2 md:grid-cols-4 text-xs gap-3">
                        {courses.map((item, i) => (
                            <div className="flex items-center gap-2 border rounded-lg border-border dark:border-border bg-muted-bg dark:bg-muted-bg hover:border-white/20 dark:hover:bg-white/7 transition-all duration-250 ease-in-out p-2 px-3">
                                <div className="w-1 h-1 border-bg bg-muted-text dark:bg-muted-text rounded-full"></div>
                                <p className="">{item}</p>
                            </div>
                        ))}
                    </div>
